...
$this->data .= "<div id='bigi'>Datos Generales</div>";
...
// SHIP TO
$this->data .= "</td><td><strong>Contacto:</strong><br>";
...
// ITEMS
$this->data .= "<table id='items'><tr><th>Descripci&oacute;n</th><th>Cantidad</th><th>Precio Unitario</th><th>Monto</th></tr>";
