...
//--------------------------------------------------
	...
	public static function save($tipoSucursal){
		...
		//var_dump($alumno);
		//die();
		$insert=$db->prepare('INSERT INTO C_tipo_sucursal VALUES (NULL, :TipoSucursal,:apellidos,:estado, 0)');
	...
	public static function all(){
		$db=DataBase::getConnect();
		$listatipoSucursal=[];
		$select=$db->query('SELECT * FROM C_tipo_sucursal order by IdTipoSucursal');
	...
	public static function searchById($id){
		$db=DataBase::getConnect();
		$select=$db->prepare('SELECT * FROM C_tipo_sucursal WHERE id=:id');
	...
	public static function delete($id){
		$db=DataBase::getConnect();
		$delete=$db->prepare('DELETE  FROM C_tipo_sucursal WHERE id=:id');
