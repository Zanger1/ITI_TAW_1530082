...
?>
		  ...
		  <div class="form-row">
			<div class="form-group col-md-12">
			  <label for="inputEmail4">Nombre del Servicio</label>
			  <input type="text" class="form-control vf_no_spl_char" id="inputEmail4" placeholder="Nombre del Servicio" value="<?php echo $Servicio->getNombreServicio(); ?>" name="NombreServicio" <?php echo $disabled; ?> required>
			</div>
		  </div>
		 <input type="text" class="form-control" value="<?php echo $Servicio->getIdServicio(); ?>" name="IdServicio" hidden>