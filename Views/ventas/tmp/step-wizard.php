						...
						<div class="box-body no-padding">
							...
							<div id="smartwizard">
								<ul>
									...
									<li><a href="#step-2">Paso 2<br /><small>Datos de entrega</small></a></li>
					...
					<!--	<form method="post" action="index.php?view=Ventas&action=save">	-->
									...
									<div id="step-2" class="">
										...
										<form method="post" action="index.php?view=Ventas&action=<?php echo $form_action; ?>&for=<?php echo $for; ?>" class="allforms" autocomplete="off">
											...
											<input type="text" class="form-control vf_no_spl_char input-type-datepicker" name="FechaIniciox" value="<?php echo $invoice_array->getFechaInicio();?>" required>
											  ...
											  <div class="form-group col-md-2">
												...
												<input type="text" class="form-control vf_no_spl_char input-type-datepicker" name="FechaTerminox" value="<?php echo $invoice_array->getFechaTermino();?>" required>
											  ...
											  <div class="form-group col-md-2">
												...
												<input type="text" class="form-control vf_no_spl_char input-type-datepicker" name="FechaEntregax" value="<?php echo $invoice_array->getFechaEntrega(); ?>" required>								
