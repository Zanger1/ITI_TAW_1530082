...
<div class="card-header">
    <small class="float-left">
      <h3 class="card-title"><?php echo $for; ?> > <span style="color: #007bff;"> Generar envi&oacute;</span></h3>
    </small>
          ...
          <section class="content">
            ...
            <div class="col-md-12">
              ...
              <form action="" method="post">              
                <select required class="select2" multiple="multiple" name="string_items[]" id="string_items" data-placeholder="Seleccionar chofer(es)">
                  <?php
  ...
  <!--- ********** by final --->
    ...
    <div class="modal-footer">
      ...
      *******************************************
      ...
      <!--<input type="submit" name="actualizar_choferes" value="Generar envio" id="button-envio" class="btn btn-primary">-->
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <?php 	
              ...
              if(isset($_POST["actualizar_choferes"]) && $clave_unica){//$_POST["clave_unica"]){
...
<input type="text" value="<?php if(isset($_GET["clave_unica"]) && $_GET["for"]){ $ListaPorClave = VentasModel::getItemsByCart($_GET["clave_unica"], $_GET["for"]); } ?>" name="for" hidden> 
