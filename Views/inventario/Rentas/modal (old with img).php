...
<!--				<select id="inputState" class="form-control" name="IdSucursal" hidden>
	...
	<div class="col-md-4">
		<div class="form-row def-photo">
			<label for="inputZip">Imagen miniatura</label>
			<?php if($inventario->getFoto()!==""){ ?>
			<img src="<?php echo $inventario->getFoto(); ?>" alt="no photo" width="100%" height="186" id="no-photo">
			<?php } else { ?>
			<img src="themes/lte/assets/dist/img/no-photo.jpg" alt="no photo" width="100%" height="186" id="no-photo">
			<?php } if($editable == "true"){ echo '<div id="filediv"><input name="file[]" class="form-control" type="file" id="file" /></div>'; }  ?>
