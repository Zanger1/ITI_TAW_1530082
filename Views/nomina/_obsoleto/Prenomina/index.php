...
<div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form method="post" id="modal-form-add" action="./index.php?view=Prenomia&action=save" autocomplete="off">
						...
						<div class="box-body no-padding">
							...
							<div class="table-responsive">
								<table id="table-data" class="table table-bordered table-striped">
									<thead>
									<tr>
                      <th>ID de Prenomina</th>
                      <th>ID Sucursal</th>
                      <th>No Semana</th>
                      <th>Fecha Inicio </th>
                      <th>Fecha Termino</th>
                      <th>Comentarios</th>
                      <th>idSituacion Prenomia</th>
                      <th>Empleado Captura</th>
                      <th>Fecha Captura</th>
                      <th>Botones</th>
