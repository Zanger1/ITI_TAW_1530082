...
<div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form method="post" id="modal-form-add" action="./index.php?view=Nomina&action=save" autocomplete="off"> <!--Cambiar el action y su origen para poder agregar xD -->
							...
							<div class="table-responsive">
								<table id="table-data" class="table table-bordered table-striped">
									...
									<tr>
											...
											<th>NUM EXRTRA MATRIZ</th>
											<th>SUCURSAL</th>
											<th>ID DE PRODUCTO EN SUCURSAL</th>
