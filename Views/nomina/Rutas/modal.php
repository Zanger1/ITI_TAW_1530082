...
?>
		...
		<div class="form-row">
			<div class="form-group col-md-12">
			  ...
			  <textarea type="text" class="form-control" id="inputPassword4" placeholder="Comentarios" name="Comentarios" <?php echo $disabled; ?>><?php echo $rutas->getComentarios(); ?></textarea>
			</div>
		</div>
